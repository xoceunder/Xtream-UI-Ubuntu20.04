...
def update(rType="MAIN"):
    ...
    rURL2 = "https://bitbucket.org/xoceunder/x-ui/raw/master/newstuff.zip"   
...
def configure():
    ...
    os.system("chattr -ai /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb ; sudo chmod 0777 /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb > /dev/null")
